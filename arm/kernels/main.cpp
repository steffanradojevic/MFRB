...
Description: Measure throughput of ARM micro-kernel, return average throughput
for the Raspberry Pi 5 equipped with Cortex A-76 Example compile command: g++
-DSIZEARRAY=505290240 -DREPEATED=2 -march=armv8.2-a readKernel1x32.s -O0
main_readKernel.cpp -o program1x32
*/
...
extern "C" int microKernel(float *arr); // Generated ARM micro-kernel
