...
Description: Experiment file for evaluating multi-striding on the RISC-V Banana Pi BPI-F3 equipped with a SpacemiT K1.
        ...
        for arr in arr_all:
            for stride in range(self.strides):
                ...
                for portion in range(self.portions):
                    ...
                    # Example = [g++ -DSIZEARRAY=505290240 -DREPEATED=2 -march=rv64gcv_zba_zbb_zbs readKernel1x32.s -O0 main_readKernel.cpp -o program1x32]
                    command = [
                        "g++",
